...
color carousel_arrow_bg_color
color carousel_item_card_bg_olor
color carousel_msg_text_color
color carousel_notification_bg_color
color carousel_title_text_color
...
color hansel_bg_opaque
color hansel_blue_dark
color hansel_blue_default
color hansel_grey_line
color hansel_grey_text
color hansel_placeholder_image
color hansel_placeholder_spinner
color hansel_red_error
color hansel_sky_blue
color hansel_transparent
color highlighted_text_material_dark
color highlighted_text_material_light
color inbox_action_button_bg_color
color inbox_action_button_text_color
color inbox_description_read_font_color
color inbox_description_unread_font_color
color inbox_message_bg_color
color inbox_timestamp_read_font_color
color inbox_timestamp_unread_font_color
color inbox_title_read_font_color
color inbox_title_unread_font_color
...
color notification_body_bg_color
color notification_header_bg_color
color notification_icon_bg_color
color notification_material_background_media_default_color
color notification_nav_arrow_bg_color
color notification_subtitle_text_color
color notification_title_text_color
color onef0000
...
dimen carousel_arrow_height
dimen carousel_arrow_padding
dimen carousel_arrow_width
dimen carousel_image_text_padding
dimen carousel_item_margin
dimen carousel_item_middle_margin
dimen carousel_item_text_margin
dimen carousel_layout_height
dimen carousel_left_right_arrow_padding
...
dimen hansel_arrow_height
dimen hansel_arrow_width
dimen hansel_btnX_click
dimen hansel_btn_gap
dimen hansel_hotspot_size
dimen hansel_img_placeholder
dimen hansel_shadow_margin_bottom
dimen hansel_shadow_padding_bottom
dimen hansel_shadow_size
...
dimen inbox_cta_layout_height
dimen inbox_description_read_font_size
dimen inbox_description_unread_font_size
dimen inbox_gif_image_layout_height
dimen inbox_gif_play_icon_height
dimen inbox_gif_play_icon_width
dimen inbox_image_layout_height
dimen inbox_image_message_layout_height
dimen inbox_inner_bottom_margin
dimen inbox_inner_item_margin
dimen inbox_inner_left_margin
dimen inbox_inner_right_margin
dimen inbox_inner_top_margin
dimen inbox_outer_left_margin
dimen inbox_outer_right_margin
dimen inbox_outer_top_margin
dimen inbox_simple_notif_height
dimen inbox_timestamp_read_font_size
dimen inbox_timestamp_unread_font_size
dimen inbox_title_read_font_size
dimen inbox_title_unread_font_size
...
dimen pn_carousel_height
dimen pn_carousel_landscape_height
dimen pn_carousel_landscape_image_height
dimen pn_carousel_landscape_title_layout_left_margin
dimen pn_carousel_msg_font_height
dimen pn_carousel_title_font_height
dimen small_icon_hw
dimen sp_14
dimen sp_16
dimen sp_20
...
dimen status_bar_button_width_height
...
dimen text_size_micro
dimen text_size_small
dimen title_end_margin
...
drawable action_backgnd_bottom_rounded_color
...
drawable grey_rounded_color
drawable hansel_check
drawable hansel_check_tick
drawable hansel_check_untick
drawable hansel_custom_seekbar
drawable hansel_heart_border
drawable hansel_heart_fill
drawable hansel_hotspot_circle1
drawable hansel_hotspot_circle2
drawable hansel_hotspot_question
drawable hansel_hotspot_star
drawable hansel_radio
drawable hansel_radio_tick
drawable hansel_radio_untick
drawable hansel_star_border
drawable hansel_star_fill
drawable hansel_thumbsup_border
drawable hansel_thumbsup_fill
drawable ic_action_pause
drawable ic_action_play
drawable ic_arrow_left
drawable ic_arrow_right
drawable ic_audio_close
drawable ic_audio_pause
drawable ic_audio_play
drawable ic_back
drawable ic_gif
...
drawable inbox_backgnd_gradient
...
drawable toolbar_backgnd_gradient
drawable tooltip_frame_dark
drawable tooltip_frame_light
drawable white_rounded_corner
id BOTTOM_END
id BOTTOM_START
id TOP_END
id TOP_START
...
id cancel_button
id card_ha
id carousel_arrow_left
id carousel_arrow_right
id carousel_icon_brand_logo
id carousel_icon_close
id carousel_image
id carousel_image_left
id carousel_image_message
id carousel_image_message_left
id carousel_image_message_right
id carousel_image_right
id carousel_image_title
id carousel_image_title_left
id carousel_image_title_right
id carousel_large_icon
id carousel_layout_header
id carousel_layout_item
id carousel_layout_item_left
id carousel_layout_item_right
id carousel_message
id carousel_title
...
id forever
id fps_text
id frag_all_tags_container_main
id frag_hsl_container_main
id fragment_container_view_tag
id frame_image_container
id frame_image_container_bottom
id frame_img_card_left
id frame_img_card_right
id frame_nps
id ghost_view
id ghost_view_holder
id gif_icon_brand_logo
id gif_icon_close
id gif_icon_play
id gif_image
id gif_large_icon
...
id gone
id group_divider
id hansel_ignore_view
id hansel_index
id hansel_nudge_view
id home
id icon
id icon_group
id icon_only
id icons_container
id image
id image_action_layout
id image_title_layout
id img1
id img1_spinner
id img3
id img_big_text
id img_h_left
id img_h_right
id img_h_spinner_left
id img_h_spinner_right
id img_icon_brand_logo
id img_icon_close
id img_image
id img_large_icon
id img_message
id img_title
id inapp_fragment_container
id inbox_notifcation_layout
id info
id input1
id input2
id input_err1
...
id iv_arrow_bottom
id iv_arrow_top
id iv_gif_image_view
id iv_gif_play_icon
id iv_hotspot_bottom
id iv_hotspot_top
id iv_image_view
id iv_landscape_carousel_image
id iv_landscape_carousel_left_arrow
id iv_landscape_carousel_right_arrow
id iv_portrait_left_carousel_arrow
id iv_portrait_left_carousel_image
id iv_portrait_right_carousel_arrow
id iv_portrait_right_carousel_image
id label0
id label1
id label2
id label3
...
id labeled
id labelled_by
id landscape_carouel_loading_progressBar
id largeLabel
id layout_bottom_btn
id layout_nps
id layout_nps_hint
id left
id left_loading_progressBar
id light
id line1
id line3
id line_btn1
...
id list_item
id llToolBar
id ll_landscape_carousel_item_layout
id ll_portrait_left_item_layout
id ll_portrait_right_carousel_layout
id loadingProgressBar
id masked
id media_actions
id message
id mini
id modal_bottom_sheet_nudge
id month_grid
...
id right
id right_icon
id right_loading_progressBar
id right_side
id rippleContainer
id rippleParentContainer
id rn_frame_file
id rn_frame_method
...
id selected
id shortcut
id simple_title_layout
id slide
id sm_icon_brand_logo
id sm_icon_close
id sm_large_icon
id sm_message
id sm_title
...
id tvProgressMsg
id tv_audio_content
id tv_audio_player_layout
id tv_audio_timestamp
id tv_audio_title
id tv_gif_message
id tv_gif_timestamp
id tv_gif_title
id tv_image_left_action
id tv_image_message
id tv_image_middle_action
id tv_image_right_action
id tv_image_timestamp
id tv_image_title
id tv_landscape_carousel_content
id tv_landscape_carousel_image_description
id tv_landscape_carousel_image_title
id tv_landscape_carousel_time
id tv_landscape_carousel_title
id tv_portrait_carousel_content
id tv_portrait_carousel_time
id tv_portrait_carousel_title
id tv_portrait_left_carousel_content
id tv_portrait_left_carousel_title
id tv_portrait_right_carousel_content
id tv_portrait_right_carousel_title
id tv_simple_left_action
id tv_simple_message
id tv_simple_middle_action
id tv_simple_right_action
id tv_simple_timestamp
id tv_simple_title
id unchecked
id uniform
id unlabeled
...
layout fps_view
layout hansel_backdrop_view
layout hansel_layout_frag
layout hansel_layout_tag
layout hansel_layout_tag_container
layout hansel_trigger_dialog
layout inapp_image_popup
layout inbox_audio_message_layout
layout inbox_carousel_landscape_layout
layout inbox_carousel_portrait_layout
layout inbox_fragment_layout
layout inbox_gif_message_layout
layout inbox_image_message_layout
...
layout notification_action_button
layout notification_action_tombstone
layout notification_audio_layout
layout notification_carousel_landscape_layout
layout notification_carousel_portrait_layout
layout notification_collapsed_layout
layout notification_gif_layout
layout notification_media_action
layout notification_media_cancel_action
layout notification_rich_image_layout
layout notification_rich_image_layout_tablet
layout notification_simple_layout
...
string NC_INTERNET_UNAVAILABLE
...
string all_notifications
string app_name
string appbar_scrolling_view_behavior
string audio_play_error
...
string err_hsl_email
string error_icon_content_description
string error_in_media_url
...
style EmptyTheme
style Hansel_SeekBarDiscrete
style Hansel_Theme_Flat_Button
